...
3. 返回JSON数组，每个元素包含：
   - title: 板块英文标题（必须准确，不要杜撰）
   - x: 板块左上角X坐标
   - y: 板块左上角Y坐标
   - width: 板块宽度，通常从左边界到右边界
   - height: 板块高度，从标题到图标网格底部
   - rows: 图标网格的行数
   - cols: 图标网格的列数
...
示例：[{"title":"Bag","x":10,"y":20,"width":900,"height":400,"rows":2,"cols":5},{"title":"Energy","x":10,"y":420,"width":900,"height":210,"rows":1,"cols":5}]`;
